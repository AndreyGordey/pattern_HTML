...
Add Life Health Fitness Free Bootstrap HTML5 Template is a simple elegant designed HTML5 Bootstrap template suits for Health and fitness industry. 
This can be also fits to  other types of health care business, Gym studio, Arerobics, sports, consultancy, portfolio and many more.
 This template is built using latest Bootstrap framework with html5 and css3 which is very easy to customise the theme as per your requirements. 
 This template designed with height quality standards. This a responsive template fits in all devices with multi browser support. Download for free.  
